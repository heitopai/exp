...
for folder in folders:
    ...
    for file in all_files:
        ...
        for tail,head,weight in insert_edges:
            ...
            from Matroid import EdgeInsertion
            start=time.time()
            T_list_tmp, AG_adj_tmp=EdgeInsertion(T_list_tmp,AG_adj_tmp,A_list_tmp,G_adj_tmp,num_vertices,tail,head,weight)
            end=time.time()
            ...
            start=time.time()
            T_list_insert, AG_adj_insert=DMST(A_list_insert,G_adj_insert,num_vertices,len(A_list_insert),root)
            end=time.time()
