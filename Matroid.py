...
def I2Arcs(A_list,T_list,num_edges,num_vertices,AG_adj):
...
def Update(A_list, G_adj, num_vertices, num_edges, T_list, AG_adj, s):
    ...
    while cycle is not None:
        ...
        I2Arcs(A_list,T_list,num_edges,num_vertices,AG_adj)
        cycle=DetectNegativeDicycle(AG_adj, A_list, T_list, num_edges, num_vertices, s)
...
def DMST(A_list,G_adj,num_vertices,num_edges,root):
    T_list,num_edges=Greedy(A_list,G_adj,num_vertices,num_edges,root)
